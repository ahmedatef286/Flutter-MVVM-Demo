...
class SchoolInfo extends StatelessWidget {
  ...
  late String studentsNo;
  late String teachersNo;

  @override
  Widget build(BuildContext context) {
    //TODO: added initialization in build to connect variables with view_model
    schoolName = Provider.of<SchoolViewModel>(context).name;
    schoolAddress = Provider.of<SchoolViewModel>(context).address;
    studentsNo = Provider.of<SchoolViewModel>(context).numberOfStudents;
    teachersNo = Provider.of<SchoolViewModel>(context).numberOfTeachers;
    return Scaffold(
      appBar: AppBar(
        toolbarHeight: 120,
                    ...
                    child: ButtonTheme(
                      ...
                      child: TextButton(
                        onPressed: () {
                          ...
                          Provider.of<SchoolViewModel>(context, listen: false)
